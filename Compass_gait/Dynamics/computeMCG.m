...
M(1, 2) = -params.m*(params.l^2/4)*cos(q1 - q2);
M(2, 1) = -params.m*(params.l^2/4)*cos(q1 - q2);
M(2, 2) = params.m*params.l^2/4;

%C matrix
C = zeros(2, 2);
C(1, 2) = -params.m*(params.l^2/4)*sin(q1 - q2)*q2d;
C(2, 1) = params.m*(params.l^2/4)*sin(q1 - q2)*q1d;
